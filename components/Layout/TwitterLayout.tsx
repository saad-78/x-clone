    ...
    <div className="fixed inset-0 overflow-hidden">
      <div className="grid grid-cols-12 h-screen w-screen sm:px-56">
        <div className="col-span-2 sm:col-span-3  pt-1 flex  sm:justify-end pr-4">
          <div>
            ...
            <div className="mt-1 text-xl  pr-4">
              ...
              <div className="mt-5 px-3">
                <button className="hidden sm:block bg-[#1d9bf0] py-3 px-4 font-semibold rounded-full w-full  text-lg">
                  Tweet
                </button>
                <button className="block sm:hidden  bg-[#1d9bf0] py-3 px-4 font-semibold rounded-full w-full  text-lg">
                  <BsTwitterX />
                </button>
              </div>
            </div>
          ...
          {user && (
            <div className="absolute bottom-5 flex gap-2 items-center bg-slate-800 px-3 py-2 p-3 rounded-full">
        ...
        <div className="col-span-10 sm:col-span-5 border-r-[1px] border-l-[1px]  border-gray-600 h-screen overflow-scroll scrollbar-hide">
          {props.children}
        </div>
        <div className="col-span-0 sm:col-span-3 p-5">
          {!user && (
            <div className="p-5 bg-slate-700 rounded-lg">
              <h2 className="my-2 text-2xl">New to X?</h2>
